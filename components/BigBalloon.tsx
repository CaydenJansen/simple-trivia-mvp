...
const BALLOON_KEYFRAMES = `@keyframes balloon-shake{0%,100%{transform:translate(0) rotate(0)}25%{transform:translate(-1px,1px) rotate(-.5deg)}75%{transform:translate(1px,-1px) rotate(.5deg)}}@keyframes balloon-shake-hard{0%,100%{transform:translate(0) rotate(0)}20%{transform:translate(-4px,2px) rotate(-2deg)}40%{transform:translate(4px,-3px) rotate(2deg)}60%{transform:translate(-3px,-2px) rotate(-2deg)}80%{transform:translate(4px,3px) rotate(2deg)}}@keyframes balloon-shake-critical{0%,100%{transform:translate(0) rotate(0) scale(1)}16%{transform:translate(-12px,7px) rotate(-9deg) scale(1.02)}33%{transform:translate(11px,-9px) rotate(10deg) scale(.98)}50%{transform:translate(-10px,-7px) rotate(-8deg) scale(1.03)}66%{transform:translate(13px,8px) rotate(9deg) scale(.97)}83%{transform:translate(-9px,6px) rotate(-7deg) scale(1.02)}}.balloon-shake{animation:balloon-shake .24s infinite}.balloon-shake-hard{animation:balloon-shake-hard .13s infinite}.balloon-shake-critical{animation:balloon-shake-critical .05s infinite}`
