...
- Steal the Treasure is server-authoritative and lasts about 30 seconds. Holding while the guard sleeps accumulates an unbanked haul; releasing banks it. A player still holding when the guard wakes loses only the unbanked haul. The highest banked total wins, and fast mobile press/release sequences must preserve the player's final intent.
