...
comment on view public.source_question_catalog is
  'RLS-aware source question catalog with normalized category/tag data, approved Audience Fit, Adult Content, Bonus tag-mode metadata, and question-and-answer search text.';
