...
- Auto-Build vibe filters include **Uber Dweeb** for geography, history, science/chemistry and traditional hard-trivia subjects, and **Pop Girly** for film, television, music, celebrities and pop culture. These are hard eligibility filters, like the existing vibe choices, and never restrict prepared tiebreakers.
